...
<form action="/ebook/manage/book/addBook" method="post" enctype="multipart/form-data">
		...
		bpdate:<input type="text" name="bpdate"/><br>
		bisbn:<input type="text" name="bisbn"/><br>
		bpurpr:<input type="text" name="bpurpr"/><br>
		bsalepr:<input type="text" name="bsalepr"/><br>
		bstock:<input type="text" name="bstock"/><br>
